...
import com.marvelapp.api.ApiConstants;
import com.marvelapp.api.ApiService;
import com.marvelapp.api.RequestInterceptor;
import com.marvelapp.data.CharacterDao;
import com.marvelapp.data.CharactersDatabase;
...
public class AppModule {
    ...
    CharactersDatabase provideCharactersDatabase(Application application) {
        return Room.databaseBuilder(application, CharactersDatabase.class, "charactersDatabase.db").build();
    }

    @Provides
    @Singleton
    CharacterDao provideArticleDao(CharactersDatabase database) {
